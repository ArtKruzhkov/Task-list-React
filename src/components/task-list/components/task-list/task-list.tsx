...
// import React, { useState, useRef, useEffect } from "react";
// import { useAppSelector } from "../../store/taskStore";
// import { useAppDispatch } from "../../store";  // Используем типизированный useDispatch
// import { deleteTask, editTask } from "../../actions/taskActions";
// import { List, ListItem, ListItemText, IconButton, Dialog, DialogActions, DialogContent, DialogTitle, TextField, Button } from "@mui/material";
// import DeleteIcon from "@mui/icons-material/Delete";
// import EditIcon from "@mui/icons-material/Edit";
...
//     const tasks = useAppSelector((state) => state.tasks);  // Используем типизированный useSelector
//     const dispatch = useAppDispatch();  // Используем типизированный useDispatch
...
//         }
//         if (editTaskText.trim()) {
//             dispatch(editTask(editTaskId!, editTaskText));  // Используем non-null assertion, так как id обязательно в момент сохранения
//             handleEditClose();
//         }
//     };
